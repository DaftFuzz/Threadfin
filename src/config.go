...
func Init() (err error) {
	...
	System.FFmpeg.DefaultOptions = "-hide_banner -loglevel panic -http_persistent 0 -reconnect_at_eof 1 -reconnect_streamed 1 -reconnect_on_network_error 0 -reconnect_on_http_error 404 -i [URL] -map 0 -map -0:a:m:language:NAR -c copy -f mpegts -lookahead_count 3 pipe:1"
